...
X, Y = sk.make_moons(n_samples=100, shuffle=True, noise=.3, random_state=None)
...
layer_dims = [2, 10, 5, 1]
parameters, _ = deep_nn_model(X, Y, num_iterations=1000, layer_dims=layer_dims, learning_rate=.01, classification_method="binary", lambd=0)
